...
namespace Zeroseven\LocalFonts\Hooks;

use TYPO3\CMS\Core\Page\PageRenderer;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use Zeroseven\LocalFonts\Loader\FontLoaderInterface;

class PageRendererHook
{
    public function loadCssFiles(array &$params, PageRenderer $pageRenderer): void
    {
        if (is_array($GLOBALS['TYPO3_CONF_VARS']['USER']['zeroseven/local-fonts'] ?? null)) {
            ...
            }, $GLOBALS['TYPO3_CONF_VARS']['USER']['zeroseven/local-fonts']));
